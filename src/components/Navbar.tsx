...
export default function Navbar() {
  ...
  return (
    <div className={`fixed top-0 left-0 right-0 z-50 transition-transform duration-300 ${
      ...
      <div className="relative text-white py-3 overflow-hidden" style={{
        ...
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center text-sm font-body h-full">
          {/* Left Section - Contact Info */}
          <div className="flex items-center space-x-8 z-10 relative flex-1">
          ...
          <div className="flex items-center space-x-3 z-10 relative ml-8">
      ...
      <nav className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center h-20">
            ...
            {/* Mobile menu button */}
            <button
              className="md:hidden bg-primary text-white p-3"
