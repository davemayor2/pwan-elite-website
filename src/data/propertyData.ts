...
export const PROPERTY_DETAILS: Record<string, PropertyDetailsData> = {
  ...
  'lavender-garden-estate': {
    ...
    heroImage: '/LAVENDER GARDEN.jpeg',
    images: ['/LAVENDER GARDEN.jpeg', '/eastView.png', '/urbanLegacy.jpg'],
    price: '₦1,500,000',
    titleType: 'Registered Survey & Deed of Assignment',
    ...
    description: [
      ...
      'All payments should be made to PWAN Elite Ltd (Account Number: 1215775853). This is your opportunity to secure a plot in a well-planned estate with modern infrastructure and excellent connectivity.',
    ],
    amenities: [
      'Perimeter Fencing',
    ...
    subscriptionFormUrl: '/LAVENDER GARDEN  ASABA 1.5M.pdf',
  },
  'haven-residence': {
  ...
  'lavender-park-estate': {
    ...
    heroImage: '/LAVENDER PARK.jpeg',
    images: ['/LAVENDER PARK.jpeg', '/eastView.png', '/urbanLegacy.jpg'],
    price: '₦3,000,000',
    titleType: 'Registered Survey & Deed of Assignment',
    plotSize: '464 Square Metres (SQM)',
    propertyType: 'Residential',
    ...
    description: [
      ...
      'All payments should be made to PWAN Elite Ltd (Account Number: 1215775853). This is your opportunity to invest in a well-planned estate with comprehensive infrastructure and security features, perfect for building your dream home or securing a valuable investment.',
    ],
    amenities: [
    ...
    subscriptionFormUrl: '/LAVENDER  PARK 3M.pdf',
  },
};
